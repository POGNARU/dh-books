...
**식구 갤러리(`family.html`)** 는 식구 캐릭터가 돋보이도록 밝고 화사한 핑크 톤을 씁니다 — 배경 그라데이션 `#FFF7FB→#FFEFF7→#FFF6EC`, 포인트 핑크 `#FF5C9E`/`#E83C86`, 화이트 카드. 카드를 누르면 뒤집혀 각 식구가 다현씨에게 남긴 한 문장이 나옵니다(2026-06-25 실제 설문).
